        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-sm-10">
                    <div class="row">
                        <div class="col-sm-7">
                            <input type="submit"  id="edit2" class="btn btn-primary" name="adddoc" value="Add New" style="display:none">
                            <input type="submit"  id="edit3" class="btn btn-primary" name="addcer" value="Add New" style="display:none"><br>
                            ...
                            <form id="gform" action="{{ action('EmployeeController@store') }}" method="post" enctype="multipart/form-data" >
